						...
						<thead>
							<tr>
								<th>
									<button
										type="button"
										className={`mdf-sort-btn${sortField === "name" ? " mdf-sort-btn--active" : ""
											}`}
								...
								<th>
									<button
										type="button"
										className={`mdf-sort-btn${sortField === "brand" ? " mdf-sort-btn--active" : ""
											}`}
								...
								<th>
									<button
										type="button"
										className={`mdf-sort-btn${sortField === "price" ? " mdf-sort-btn--active" : ""
											}`}
				...
				>
					<div style={{ display: "grid", gap: 16, minWidth: 420 }}>
						...
						<div
							role="separator"
							aria-hidden="true"
							style={{ borderTop: "1px solid #e1e1e1", margin: "8px 0" }}
						/>
